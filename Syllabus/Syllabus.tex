...
\reading{HallWayman1990} % Hall, Richard, & Frank Wayman, “Buying time: Moneyed interests and the mobilization of bias in congressional committees.” American Political Science Review, vol. 84 (1990), pp. 797–820.
...
\reading{Austen-SmithWright1994} % Austen-Smith, David, and John R. Wright. 1994. “Counteractive Lobbying.” American Journal of Political Science 38: 25-44.
...
\reading{Gelmanetal2007} % Andrew Gelman, Joseph Bafumi, David Park and Boris Shor.  2007.  “Rich state, poor state, red state, blue state: What’s the matter with Connecticut?”  Quarterly Journal of Political Science.
% electoral college
...
\clearpage
\subsection{Elite and Mass Polarization (Week 45)}
\emph{Topic}
\vspace{1em}
\subsubsection*{Readings}
...
\clearpage
\subsection{Political Participation (Week 46)}
\emph{Topic}
\vspace{1em}
\subsubsection*{Readings}
...
\clearpage
\subsection{American Values and Opinions (Week 47)}
\emph{Topic}
\vspace{1em}
\subsubsection*{Readings}
...
\clearpage
\subsection{Policy Controversies (Weeks 50--51)}
\emph{Topic}
\vspace{1em}
\subsubsection*{Readings}
