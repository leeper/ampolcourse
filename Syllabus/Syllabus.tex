...
\section{Exam}
Students will be evaluated via an oral examination with a written synopsis based upon issues raised in the course.
...
\clearpage
\subsection{Exam Preparation I: Public Policy (Week 46)\\(Meet 1 hour)}
...
\noindent After your discussions, use remaining time to generate ideas for your own synopsis. What controversy would you like to explore and what factors will you examine to better understand that controversy?
...
\clearpage
\subsection{Politics of Race and Inequality (Week 47)\\(Meet 8:00--12:30)}
