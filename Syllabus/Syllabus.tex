...
\reading{Dahl1961} % Who Governs?

% something by Eric Oliver
% Oliver, J. Eric and Shang E. Ha. 2007. “Vote Choice in Suburban Elections,”  The American Political Science Review 101(3): 393-408. 


\reading{HajnalGerberLouch2002} %http://onlinelibrary.wiley.com/doi/10.1111/1468-2508.00122/abstract


\seealso
% something on nullification? http://en.wikisource.org/wiki/South_Carolina_Exposition_and_Protest
\reading{ReganPriscilla2009} % REAL ID resistance
...
\emph{How do elections work? Who votes? What actors influence election outcomes?}
\vspace{1em}
\subsubsection*{Readings}
...
\emph{How politically polarized is hte United States? Where does polarization come from and what are its effects?}
\vspace{1em}
\subsubsection*{Readings}
...
\reading{McCartyPooleRosenthall2009} % gerrymandering
...
\reading{Sumner1883} Available from: \url{http://www.gutenberg.org/ebooks/18603}
